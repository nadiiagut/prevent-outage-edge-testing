...
- No automatic pack selection — you must know what you need
- No feature context — tests are generic for the obligation
...
- [docs/jira.md](jira.md) — Jira integration details
- [docs/outputs.md](outputs.md) — Output artifact descriptions
